...
<template>
    <div class="flex w-full h-screen">
        <!-- Sidebar -->
        <div
            :class="`sidebar transition-width duration-700 ease-out overflow-hidden ${isSidebarVisible ? 'w-[15%] sm:w-[13%]' : 'w-0'} h-full text-white shadow-lg`">
            ...
            <nav class="mt-5 px-2">
                <ul class="space-y-2">
                    <li
                        class="flex items-center header font-bold p-4 cursor-pointer active-hover transition-all duration-300 ease-in-out rounded-[45px_10px_45px]"
                    ...
                    <li class="flex items-center header font-bold p-4 cursor-pointer active-hover transition-all duration-300 ease-in-out rounded-[45px_10px_45px]"
        ...
        <!-- Main Content Area -->
        <div
            :class="`transition-width duration-700 ease-out ${isSidebarVisible ? 'w-[85%] sm:w-[88%]' : 'w-full'} h-full`">
            <div class="top-bar w-full h-16 bg-gray-900 text-white flex justify-between items-center p-5 shadow-md">
...
.active-hover:hover {
    ...
    background: linear-gradient(100deg, #02278c 0%, #02278c 100%); /* Tailwind's indigo-600 */
}
.sidebar{
